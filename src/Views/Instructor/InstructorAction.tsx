...
import './InstructorAction.css'

export class InstructorAction extends React.Component{
    render() {
        return (
            <div className=''>
                <section className="scam">
                    <div className="container max-w-6xl mx-auto text-white">
                        <h2 className="text-4xl font-bold tracking-tight text-center">Choose Your Action</h2>
                        <div className="grid grid-cols-4 gap-8 mt-5 sm:grid-cols-8 lg:grid-cols-12 sm:px-8 xl:px-0 glass">
                            ...
                            <div className="relative flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 overflow-hidden bg-gray-100 sm:rounded-xl">
                                ...
                                <p className="text-base text-center">Each of our plan will provide you and your team with certifications.</p>
                            </div>
                            ...
                            <div className="flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 bg-gray-100 sm:rounded-xl">
                                ...
                                <p className="text-base text-center">Send out notifications to all your customers to keep them engaged.</p>
                            </div>
                            ...
                            <div className="flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 bg-gray-100 sm:rounded-xl">
                                ...
                                <h4 className="text-xl font-medium">Bundles</h4>
                                <p className="text-base text-center">High-quality bundles of awesome tools to help you out.</p>
                            </div>
                            ...
                            <div className="flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 bg-gray-100 sm:rounded-xl">
                                ...
                                <h4 className="text-xl font-medium">Developer Tools</h4>
                                <p className="text-base text-center">Developer tools to help grow your application and keep it up-to-date.</p>
                            </div>
                            ...
                            <div className="flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 bg-gray-100 sm:rounded-xl">
                                ...
                                <h4 className="text-xl font-medium">Building Blocks</h4>
                                <p className="text-base text-center">The right kind of building blocks to take your company to the next level.</p>
                            </div>
                            ...
                            <div className="flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 bg-gray-100 sm:rounded-xl">
                                ...
                                <p className="text-base text-center">Coupons system to provide special offers and discounts for your app.</p>
                            </div>
