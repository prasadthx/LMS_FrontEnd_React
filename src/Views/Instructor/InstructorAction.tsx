                    ...
                    <div className="container max-w-6xl mx-auto text-white">
                        ...
                        <div className="grid grid-cols-4 gap-8 mt-5 sm:grid-cols-8 lg:grid-cols-12 sm:px-8 xl:px-0 glass">
                            ...
                            <div className="relative flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 overflow-hidden bg-gray-100 sm:rounded-xl">
                                ...
                                <h4 className="text-xl font-medium">Instructor Profile</h4>
                                <p className="text-base text-center"> Manage your Instructor Profile </p>
                            </div>
                            ...
                            <div className="flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 bg-gray-100 sm:rounded-xl">
                                ...
                                <h4 className="text-xl font-medium">Lectures</h4>
                                <p className="text-base text-center"> Upload Lectures for students and many more </p>
                            </div>
                            ...
                            <div className="flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 bg-gray-100 sm:rounded-xl">
                                ...
                                <h4 className="text-xl font-medium">Student Performance</h4>
                                <p className="text-base text-center"> Manage student attendance and performance </p>
                            </div>
                            ...
                            <div className="flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 bg-gray-100 sm:rounded-xl">
                                ...
                                <h4 className="text-xl font-medium">Assignments</h4>
                                <p className="text-base text-center">Manage Assignments for Students</p>
                            </div>
                            ...
                            <div className="flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 bg-gray-100 sm:rounded-xl">
                                ...
                                <h4 className="text-xl font-medium">Exam</h4>
                                <p className="text-base text-center">Conduct Exams to evaluate students</p>
                            </div>
                            ...
                            <div className="flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 bg-gray-100 sm:rounded-xl">
                                ...
                                <h4 className="text-xl font-medium">Class Chat</h4>
                                <p className="text-base text-center">Chat With Class Students.</p>
                            </div>
